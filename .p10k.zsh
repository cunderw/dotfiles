# Generated by Powerlevel10k configuration wizard on 2022-05-05 at 10:53 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=003
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=004
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=006
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=004
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND=006
  # Custom icon.
